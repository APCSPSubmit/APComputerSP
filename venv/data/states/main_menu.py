...
class Menu(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.overhead_info = info.OverheadInfo(self.game_info,
                                               c.MAIN_MENU)
    ...
    def get_image(
        ...
        """Returns image and rects to blit onto the screen"""
        ...
        if sprite_sheet == setup.GFX['title_screen']:
            ...
            image = pg.transform.scale(image, (int(rect.width
                                                   * c.SIZE_MULTIPLIER), int(rect.height
                                                                             * c.SIZE_MULTIPLIER)))
        else:
            image.set_colorkey(c.BLACK)
            image = pg.transform.scale(image, (int(rect.width * 3),
                                               int(rect.height * 3)))
